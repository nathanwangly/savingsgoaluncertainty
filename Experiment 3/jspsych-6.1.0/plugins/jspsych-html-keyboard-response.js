...
jsPsych.plugins["html-keyboard-response"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if(trial.topleft == true){
      new_html += '<div id="jspsych-survey-text-custom-topleft" class="topleft"><font size="6"><b>Score: '+score+' points</b></font></div>';
    }

    // show top right corner text
    if(trial.topright == true){
      new_html += '<div id="jspsych-survey-text-custom-topright" class="topright"><font size="6"><b>Savings: $'+savings+'</b></font></div>';
    }
