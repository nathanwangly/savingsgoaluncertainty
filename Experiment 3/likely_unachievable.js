/* condition: likely unachievable -- ranges between $6,500-$10,500 */
/* NOTE: was later renamed to "unlikely achievable" for consistency */
...
var min_savings_goal = 6500;
var max_savings_goal = 10500;
...
var uncertain_level = 'likely unachievable'
...
var savings_reward = 45000
  ...
  // comprehension check
var comprehension_correct = false;
var comprehension_rounds = n_exp_rounds;
var comprehension_income = income * n_exp_rounds;

  // goal achievability rating
var achievability = 0;
...
'<p><b>Your objective in this game is to manage your spending and saving behaviour to score as many points as possible.</b></p>' +
...
var comprehension = {
  ...
  preamble: '<h2>Comprehension Check</h2>' + 
            '<br>Please answer the following questions to confirm that you have understood the experiment instructions.',
  html: '<br><br><p>How many rounds will there be in the experiment?</p><input name="check_rounds" type="number" style="width: 5em; height: 1.5em; font-size:1.2em" required/></p>' +
  '<br><p>What is the total amount of money you will receive?</p><input name="check_income" type="number" style="width: 5em; height: 1.5em; font-size:1.2em" required/></p>' +
  '<br>',
  on_finish: function(data){
    ...
    // validate responses
    if (responses.check_rounds == comprehension_rounds & responses.check_income == comprehension_income) {
      comprehension_correct = true;
    }
  }
}

/* create loop if participant provides incorrect responses */
var comprehension_incorrect = {
  type: 'html-button-response',
  stimulus: function() {
    return 'Your responses were incorrect.' +
    '<p>Please review the instructions summary and try again.</p>' +
    '<br>'
  },
  choices: ['<p style="font-size:130%;line-height:0%;"><b>Review instructions</b></p>']
};

var comprehension_review = {
  type: 'html-button-response',
  stimulus: function() {
    return instruction_summary_string + '<br>'
  },
  choices: ['<p style="font-size:130%;line-height:0%;"><b>Retry comprehension check</b></p>']
}

var comprehension_loop = {
  timeline: [comprehension_incorrect, comprehension_review, comprehension],
  loop_function: function() {
    if (comprehension_correct == true) {
      return false;
    } else if (comprehension_correct == false) {
      return true;
    }
  },
...
var instructions_stage = {
  timeline: [starting_instructions, comprehension, comprehension_loop, start_practice_rounds],
}
...
var goal_achievability = {
  type: 'html-slider-response',
  stimulus: '<p>Before beginning the experiment rounds, please provide a rating on the scale below.</p>' +
            '<br><p>On a scale of 0 to 10, how possible do you think it is to save enough to reach the goal?</p>' + 
            '<p>0 = Definitely not possible; 10 = Definitely possible',
  ...
  on_finish: function(trial) {
    achievability += trial.response / 10;
    jsPsych.data.addProperties({achievability: achievability});

  }
}

var end_practice_rounds = {
  timeline: [end_stage_p, instructions_reminder, goal_achievability]
};
